...
REM 创建输出目录结构
echo [2/6] 创建输出目录...
if exist "SQL_AI_Copilot_Simple" rmdir /s /q "SQL_AI_Copilot_Simple"
mkdir "SQL_AI_Copilot_Simple"
mkdir "SQL_AI_Copilot_Simple\config"
mkdir "SQL_AI_Copilot_Simple\include"
mkdir "SQL_AI_Copilot_Simple\docs"

REM 编译项目（使用简化版本）
echo [3/6] 编译项目...

echo 使用简化版本（仅依赖Windows系统库）...
g++ -std=c++11 -Iinclude -o "SQL_AI_Copilot_Simple\sql_ai_copilot.exe" ^
    main.cpp ^
...
REM 复制配置文件
copy "config\ai_models.json" "SQL_AI_Copilot_Simple\config\" >nul

REM 复制头文件
xcopy "include\*" "SQL_AI_Copilot_Simple\include\" /Y /Q >nul

REM 复制原始README
copy "README.md" "SQL_AI_Copilot_Simple\docs\原始README.md" >nul

REM 创建启动脚本
echo 创建启动脚本...
(
echo @echo off
echo title SQL AI Copilot - 简化版
echo color 0A
echo.
echo echo ========================================
...
echo echo 程序已退出
echo pause
) > "SQL_AI_Copilot_Simple\启动程序.bat"

REM 创建详细说明文件
echo 创建说明文件...
(
echo SQL AI Copilot - Windows 简化版可执行文件包
echo ========================================
echo.
echo 版本信息：
echo - 编译时间：%date% %time%
...
echo 简化版特性：
echo ==========
echo - 仅依赖Windows系统库（winhttp.lib）
echo - 无需安装额外的开发库
echo - 更小的文件体积
echo - 更好的兼容性
echo.
...
echo.
echo ========================================
echo 感谢使用 SQL AI Copilot 简化版！
echo ========================================
) > "SQL_AI_Copilot_Simple\使用说明.txt"
...
echo echo.
echo pause
) > "SQL_AI_Copilot_Simple\配置向导.bat"

REM 创建版本信息文件
echo 创建版本信息...
(
echo SQL AI Copilot - 简化版
echo 版本：1.0.0-Simple
echo 编译时间：%date% %time%
echo 目标平台：Windows x64
echo 编译器：MinGW-w64
echo 版本类型：简化版（仅依赖Windows系统库）
echo.
echo 功能特性：
...
echo.
echo 依赖库：
echo - winhttp.lib（Windows HTTP API）
echo - libstdc++（C++标准库）
echo.
echo 简化版优势：
echo - 无需额外依赖库
...
echo - 更好的兼容性
echo - 更容易部署
) > "SQL_AI_Copilot_Simple\版本信息.txt"
...
echo ========================================
echo.
echo 输出文件夹：SQL_AI_Copilot_Simple
echo.
echo 包含文件：
...
echo.
echo 使用方法：
echo 1. 进入 SQL_AI_Copilot_Simple 文件夹
echo 2. 双击"启动程序.bat"
echo 3. 按照程序提示操作
echo.
echo 简化版特性：
...
echo - 更好的兼容性
echo.
echo 打包完成！可以分发 SQL_AI_Copilot_Simple 文件夹
echo ========================================
